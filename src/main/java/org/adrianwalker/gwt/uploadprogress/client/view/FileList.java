...
import org.adrianwalker.gwt.uploadprogress.client.controller.ProgressController;
  ...
  private final class FilesListener implements PropertyChangeListener {
    ...
    public void propertyChange(final PropertyChangeEvent event) {
      ...
      for (int i = 0; i < files.size(); i++) {
        ...
        Anchor anchor = new Anchor(fileName, "uploadprogress/download?file=" + fileName);
